...
const ContactUs = () => {
  ...
  return (
    <>
      {screenSize < 768 ? (
        <>
          <div className="m-10 m-14">
            <img src={contactpic} alt="contact" className="h-60 w-full"></img>
          </div>
          <div className="bg-indigo-100 pt-6">
            <div className="my-16">
              <h1 className=" text-3xl font-bold px-10 text-center ">
                Get In Touch!
              </h1>
              <h2 className=" px-10 text-center py-4 ">
