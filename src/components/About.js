      ...
      <div className="px-4 md:px-10 lg:px-20 xl:px-30">
        <div className="">
          <h1 className="text-center font-bold text-2xl md:text-2xl lg:text-3xl xl:text-4xl pt-6">
            We're here to <br /> gurantee your success
          </h1>
        ...
        <img
          src={about1}
          alt="aboutmain"
          className=" w-full h-1/2 relative bottom-20 -mb-44"
        />
        <div className="">
          <h1 className="text-center font-bold  text-2xl md:text-2xl lg:text-3xl xl:text-4xl pt-6">
            We're here for you <br /> no matter where you are
          </h1>
          <hr class=" mx-[2%] pb-10 border-t border-gray-300" />
        </div>
        <div>
        ...
        <div className="">
          <h1 className="text-2xl font-bold md:text-2xl lg:text-3xl xl:text-4xl pt-6">
            Our Mission
          </h1>
          <hr class=" mx-[2%] pb-10 border-t border-gray-300" />
        </div>
        <div className="md:grid grid-cols-3">
          ...
          <h1 className="text-md font-bold lg:text-xl xl:text-2xl">Specific</h1>
          <p className=" col-span-2 pb-[5%] text-md md:text-md lg:text-xl xl:text-2xl">
        ...
        <div className="">
          <h1 className="text-center font-bold  text-2xl pt-6">
            Our Success Team
          </h1>
        </div>
      </div>
